...
function App() {
  ...
  const connect = (relayPeerId: string) => {
    createClient(relayPeerId)
      .then((client) => {
        ...
        client.callServiceHandler.onEvent("CharCountPeer", "character_count", (args) => {
          const [msg] = args;
  ...
  const helloBtnOnClick = async () => {
    ...
    const res_count = await charCount(client!, peerIdInput, relayPeerIdInput, res);
    setCharCountMessage(res_count);
  };
